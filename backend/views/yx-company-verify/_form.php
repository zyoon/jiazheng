...
<!--     <?php $verify_sate= $model->getVerifyState(); ?>
    <?= $form->field($model, 'verify_sate')->dropDownList($verify_sate) ?> -->
   ...
   <?= $form->field($model, 'cmp_user_id')->textInput()->hiddenInput(['value'=>$model->cmp_user_id])->label(false); ?>
   ...
   <?= $form->field($model, 'total_fraction')->textInput() ?>

   <?= $form->field($model, 'base_fraction')->textInput() ?>

   <?= $form->field($model, 'history_fraction')->textInput() ?>

   <?= $form->field($model, 'clinch')->textInput() ?>
