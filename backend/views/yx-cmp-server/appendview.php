...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', '已选服务列表'), 'url' => ['index?company_id=' . $model->company_id]];
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', '附加服务列表'), 'url' => ['append?company_id='.$model->company_id. '&server_id=' . $model->server_parent_id]];
