...
<div class="yx-staff-verify-form">

    <?php $form = ActiveForm::begin(); ?>

    <?= $form->field($model, 'id')->textInput()->hiddenInput(['value'=>$model->id])->label(false); ?>

    <?= $form->field($model, 'staff_id')->textInput()->hiddenInput(['value'=>$model->staff_id])->label(false); ?>
    ...
    <?php $staff_sex = YxStaff::getCmpSex(); ?>
    <?= $form->field($model, 'staff_sex')->dropDownList($staff_sex) ?>
...
<!--     <?= $form->field($model, 'staff_query')->textarea(['rows' => 6]) ?> -->

<!--     <?= $form->field($model, 'staff_verify_state')->textInput() ?> -->

    <?= $form->field($model, 'staff_verify_memo')->textarea(['rows' => 6]) ?>

    <?php $staff_manage_time = YxStaff::getStaffTime(); ?>
   ...
   <?= $form->field($model, 'staff_idcard_back')->widget(QiniuFileInput::className(),[
    ...
    <?php $staff_educate = YxStaff::getStaffEducate(); ?>
