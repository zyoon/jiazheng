...
<div class="yx-recom-right-form">

    <?php $form = ActiveForm::begin(); ?>

    <?= $form->field($model, 'recom_right_pic')->widget(QiniuFileInput::className(),[
    ...
    <?= $form->field($model, 'recom_right_href')->textInput(['maxlength' => true]) ?>
