...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', '附加服务列表'), 'url' => ['append?staff_id='.$model->staff_id. '&server_id=' . $model->server_parent_id]];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="yx-staff-server-appendview">

    <h1><?=Html::encode($this->title);?></h1>

    <p>
        <?=Html::a(Yii::t('app', '修改'), ['appendupdate', 'staff_id' => $model->staff_id, 'server_id' => $model->server_id], ['class' => 'btn btn-primary']);?>
