...
<div class="yx-staff-res-form">

    <?php $form = ActiveForm::begin(); ?>

    <?= $form->field($model, 'staff_id')->textInput()->textInput()->hiddenInput(['value'=>$model->staff_id])->label(false); ?>

    <?= $form->field($model, 'staff_res_img')->widget(QiniuFileInput::className(),[
